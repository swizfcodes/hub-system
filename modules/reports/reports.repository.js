...
// ── SAVED REPORTS ────────────────────────────────────────────
// A user saves a report configuration (type + filters + columns +
// sort + optional schedule) to re-run later. is_shared exposes it
// to the whole business; otherwise it's private to the creator.
