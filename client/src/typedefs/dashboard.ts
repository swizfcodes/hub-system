...
export interface LogisticsDashboard {
  ...
  by_courier:       { courier: string; total: number; delivered: number; success_rate: number }[];
  active_deliveries: { delivery_id: string; delivery_number: string; status: string; contact_name: string }[];
}
