...
export default function PermissionsPage() {
  ...
  return (
    <>
      <Topbar title="Permissions & Roles" subtitle="RBAC · role matrix · user access" />
      <div className="px-4 sm:px-8 py-6 sm:py-10 max-w-7xl mx-auto">
        <PageHeader
          ...
          crumbs={[{ label: 'Hub', to: '/' }, { label: 'Settings', to: '/settings' }, { label: 'Permissions & Roles' }]}
        />
        <Tabs
          tabs={[{ key: 'roles', label: 'Roles' }, { key: 'users', label: 'Users' }]}
          active={tab}
