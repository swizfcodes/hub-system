    ...
    <>
      ...
      <div className="px-4 sm:px-8 py-6 sm:py-10 max-w-7xl mx-auto">
        <div className="mb-8 flex items-center justify-between gap-4 flex-wrap">
          <Breadcrumbs items={[{ label: 'Hub', to: '/' }, { label: 'Settings' }]} />
          <Link
            to="/"
        ...
        <header className="mb-10 animate-app-in">
          <p className="text-[0.7rem] tracking-[0.18em] uppercase text-orika-gold mb-2">Configuration</p>
          ...
          <p className="mt-3 text-sm sm:text-base text-orika-cloud max-w-2xl">
            Every knob, dial, and switch for your two businesses lives here — business identity, banking,
            tax, branding, pipelines, document numbering and role-based access control.
          </p>
        </header>

        <section>
          <div className="flex items-center gap-4 mb-5">
            <div className="text-[0.65rem] tracking-[0.18em] uppercase text-orika-gold">Modules</div>
