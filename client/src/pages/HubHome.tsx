      ...
      <div className="px-4 sm:px-8 py-6 sm:py-10 max-w-7xl mx-auto">
        ...
        <section className="mb-10 sm:mb-12 animate-app-in">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
            <div>
              ...
              <h1 className="font-display font-light text-3xl sm:text-5xl lg:text-6xl leading-tight text-orika-cream">
                ...
                <span className="italic text-orika-gold">craft</span> today?
              </h1>
              <p className="mt-3 text-sm sm:text-base text-orika-cloud max-w-xl">
                {greeting.secondary}
              </p>
            </div>
          ...
          <div className="grid gap-3 sm:gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
            <Link
              to="/invoicing"
              className="group p-4 sm:p-5 rounded-2xl border border-orika-graphite bg-gradient-to-br from-orika-gold/[0.04] to-transparent hover:border-orika-gold/40 transition-all"
            >
            ...
            <Link
              to="/sales"
              className="group p-4 sm:p-5 rounded-2xl border border-orika-graphite bg-gradient-to-br from-living-sage/[0.04] to-transparent hover:border-living-sage/40 transition-all"
            >
              <div className="flex items-start gap-3">
            ...
            <Link
              to="/crm"
              className="group p-4 sm:p-5 rounded-2xl border border-orika-graphite bg-gradient-to-br from-bejewelled-rose/[0.04] to-transparent hover:border-bejewelled-rose/40 transition-all"
            >
              <div className="flex items-start gap-3">
        ...
        <section>
          <div className="flex items-center gap-4 mb-5">
            <div className="text-[0.65rem] tracking-[0.18em] uppercase text-orika-smoke">
              Recent Activity
            </div>
            <span className="text-[0.6rem] text-orika-smoke/60">
            ...
            <div className="rounded-2xl border border-orika-graphite bg-orika-charcoal/40 divide-y divide-orika-graphite/50">
              {auditFeed.map((entry) => (
                ...
                >
                  ...
                  <span className="text-[0.65rem] text-orika-smoke shrink-0">
