      ...
      <div className="px-4 sm:px-8 py-6 sm:py-8 max-w-6xl mx-auto">
        ...
        <header className="mb-6">
          ...
          <h1 className="font-display font-light text-3xl sm:text-4xl text-orika-cream">
            Match{" "}
            <span className="italic text-orika-gold">PO + GRN + Bill</span>
          </h1>
        </header>
        ...
        {isLoading ? (
          ...
          <Card className="p-6 text-center">
            <p className="text-sm text-orika-smoke">
              Open a PO and click "Match supplier bill" to land here with the PO
              pre-attached.
            </p>
          </Card>
        ) : (
          <Card className="overflow-hidden">
              ...
              <table className="w-full text-sm">
                <thead className="bg-orika-charcoal border-b border-orika-graphite">
                  <tr>
                    ...
                    <th className="px-4 py-2 text-center text-[0.6rem] tracking-widest uppercase text-orika-smoke">
                      Match
                    </th>
                  </tr>
                </thead>
                  ...
                  {(po.lines ?? []).map((l) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-4 py-2.5 text-right text-orika-smoke italic">
                          —
                        </td>
                        ...
                        <td className="px-4 py-2.5 text-center">
                          {qtyMatch ? (
                            <span className="inline-flex items-center gap-1 text-living-sage text-xs">
                              <Check className="w-3 h-3" /> qty
                            </span>
                          ) : (
                            <span className="inline-flex items-center gap-1 text-state-warn text-xs">
            ...
            <div className="px-5 py-4 border-t border-orika-graphite text-xs text-orika-smoke">
              Auto-tolerance: ±5% on quantity, ±2% on price. Exceptions are
