...
import type {
  ArrangementType, ConsignmentStatus, SettlementStatus, SettlementCycle,
...
export const ARRANGEMENT_OPTIONS: SelectOption[] = [
  { value: 'consignment', label: 'Consignment — stock stays ours, partner sells on our behalf' },
  { value: 'wholesale',   label: 'Wholesale — outright sale to partner at discounted price'    },
