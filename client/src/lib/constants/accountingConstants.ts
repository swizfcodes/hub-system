...
export const ACCOUNT_TYPE_META: Record<AccountType, {
  label: string; tone: BadgeProps['tone']; color: string; normalBalance: 'DR' | 'CR';
}> = {
  asset:     { label: 'Asset',     tone: 'info',    color: '#4E9AF1', normalBalance: 'DR' },
  liability: { label: 'Liability', tone: 'danger',  color: '#E74C3C', normalBalance: 'CR' },
  equity:    { label: 'Equity',    tone: 'plum',    color: '#9B59B6', normalBalance: 'CR' },
  income:    { label: 'Income',    tone: 'sage',    color: '#2ECC71', normalBalance: 'CR' },
  expense:   { label: 'Expense',   tone: 'warn',    color: '#E67E22', normalBalance: 'DR' },
};
...
export const AGING_BUCKET_META: Record<AgingBucket, { label: string; tone: BadgeProps['tone'] }> = {
