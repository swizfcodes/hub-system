...
export const createInvoiceSchema = z.object({
  ...
  invoice_type:        z.enum(['standard', 'proforma', 'retail_partner_settlement']).default('standard'),
...
export const recordPaymentSchema = z.object({
  ...
  payment_method:     z.enum(['bank_transfer', 'pos_card', 'cash', 'paystack', 'flutterwave']),
