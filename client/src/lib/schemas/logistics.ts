...
export const createDeliverySchema = z.object({
  ...
  fee_borne_by:     z.enum(['customer', 'business', 'split']).optional().default('customer'),
});
...
export const signatureSubmitSchema = z.object({
  customer_signature: z.string().startsWith('data:image/png;base64,', 'Draw customer signature'),
  driver_signature:   z.string().startsWith('data:image/png;base64,', 'Draw driver signature'),
