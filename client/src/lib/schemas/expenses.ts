...
export const createExpenseSchema = z.object({
  category:          z.enum([
    'rent','transport','office_supplies','meals','client_entertainment',
    'utilities','maintenance','marketing','insurance','professional_fees','other',
  ], { required_error: 'Select a category' }),
  expense_type:      z.enum(['reimbursement','petty_cash','direct_payment']).default('reimbursement'),
