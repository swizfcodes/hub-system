...
export const CONTACT_TYPES = ['customer', 'supplier', 'staff', 'retail_partner'] as const;
export const PRIORITY_LEVELS = ['vip', 'regular', 'new'] as const;
export const CONTACT_SOURCES = ['walk_in', 'social_media', 'referral', 'website', 'event'] as const;
...
export const addressSchema = z.object({
  address_type:   z.enum(['delivery', 'billing', 'office', 'home', 'other']).default('delivery'),
