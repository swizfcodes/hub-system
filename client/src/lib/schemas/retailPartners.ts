...
export const createPartnerSchema = z.object({
  ...
  partner_code:            z.string().min(2, 'Code required').max(20).regex(/^[A-Z0-9_-]+$/, 'Uppercase letters, numbers, dashes only'),
  ...
  settlement_cycle:        z.enum(['weekly', 'biweekly', 'monthly']).optional().default('monthly'),
