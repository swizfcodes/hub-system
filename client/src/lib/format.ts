...
const CURRENCY_SYMBOLS: Record<string, string> = {
  NGN: '₦', USD: '$', GBP: '£', EUR: '€', CAD: 'C$', GHS: 'GH₵', ZAR: 'R',
};
...
export function fmtPercent(rate: number | string | null | undefined, decimals = 2): string {
...
export function previewSeq(prefix: string, next: number, padding: number): string {
