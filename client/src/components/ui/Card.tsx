...
export function Card({ surface='dark', interactive, accent, className, children, ...rest }: CardProps) {
  return (
    <div
      className={cn(
        ...
        interactive && 'cursor-pointer hover:-translate-y-1 hover:shadow-card-lg hover:border-orika-gold/40',
        className,
      )}
      {...rest}
    >
