  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        <div className="w-full max-w-sm rounded-2xl bg-orika-charcoal border border-white/10 shadow-2xl overflow-hidden">

          {/* Header */}
          <div className="flex items-center justify-between px-5 py-4 border-b border-white/8">
            <div className="flex items-center gap-2.5">
              <QrCode className="h-4 w-4 text-orika-gold" />
              <div>
            ...
            <button
              onClick={onClose}
              className="rounded-lg p-1.5 hover:bg-white/8 text-orika-smoke hover:text-orika-cream transition"
            >
              <X className="h-4 w-4" />
            </button>
          </div>
          ...
          <div className="p-5 space-y-4">
            ...
            {data && (
              <>
                ...
                {/* Instruction */}
                <p className="text-xs text-orika-smoke text-center leading-relaxed">
                ...
                {/* Link display */}
                <div className="flex items-center gap-2 rounded-xl border border-white/10 bg-orika-graphite px-3 py-2">
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      copied ? "text-green-400" : "text-orika-gold hover:underline",
                    )}
                  >
                    {copied ? "Copied!" : "Copy"}
                  </button>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <button
                    ...
                    className="flex items-center justify-center gap-2 rounded-xl border border-white/10 bg-orika-graphite px-4 py-2.5 text-sm text-orika-cloud hover:border-white/20 hover:text-orika-cream transition"
                  >
                  ...
                  <button
                    onClick={handleCopy}
                    className="flex items-center justify-center gap-2 rounded-xl bg-orika-gold/10 border border-orika-gold/30 px-4 py-2.5 text-sm text-orika-gold hover:bg-orika-gold/20 transition"
                  >
