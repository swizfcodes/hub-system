...
function Column({ stage, onNewDeal }: { stage: PipelineStageWithDeals; onNewDeal: (s?: string) => void }) {
  ...
  return (
    <div className="w-72 shrink-0 flex flex-col rounded-2xl bg-orika-charcoal/40 border border-orika-graphite overflow-hidden">
      ...
      <button
        ...
        className="w-full px-3 py-2 text-[0.65rem] uppercase tracking-widest font-semibold text-orika-smoke hover:text-orika-gold hover:bg-orika-charcoal/60 border-t border-orika-graphite/70 inline-flex items-center justify-center gap-1.5 transition-colors"
      >
