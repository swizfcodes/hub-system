    ...
    <>
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          {title && (
            <h1 className="font-display text-lg sm:text-xl text-orika-cream truncate leading-tight">
              {title}
            </h1>
          )}
          {subtitle && (
            <p className="text-[0.7rem] sm:text-xs text-orika-smoke truncate">
              {subtitle}
            </p>
          )}
        </div>
        ...
        >
          ...
          <kbd className="ml-auto text-[0.6rem] px-1.5 py-0.5 bg-orika-charcoal border border-orika-graphite rounded font-mono">
            Cmd+K
          </kbd>
        </button>
